...
import type { AlphaRouterConfig } from '@totality-fi/smart-order-router'
...
} from '@totality-fi/smart-order-router'
...
function getRouter(chainId: ChainId, provider: BaseProvider): AlphaRouter {
  ...
  // TODO(zzmp): Upstream to @totality-fi/smart-order-router, exporting an enum of supported v2 chains for clarity.
  ...
  // TODO(zzmp): Upstream to @totality-fi/smart-order-router, possibly making this easier to modify
